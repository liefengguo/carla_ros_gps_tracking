...
bool loadPath(string filename , vector<double> &r_x,vector<double> r_y) {
...
int main(int argc, char **argv) {
  ...
  //创建节点句柄
  ros::NodeHandle n;
  std::string points_filename = n.param<std::string>("gps_points", "/home/chen/ros_work/lidar/src/referenline_points/gps_points.txt");
  loadPath(points_filename , r_x_,r_y_);
